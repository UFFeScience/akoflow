...
func registerExecutionHandlers(
	...
	preparer := applicationtransfer.Coordinator{Catalog: data, Materializer: applicationtransfer.Materializer{Resolver: resolver, Connectors: []ports.TransferConnector{

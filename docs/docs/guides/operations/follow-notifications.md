...
notification record to query for them. For a durable cross-domain timeline,
query `/audit-events/` with the relevant execution, session, connection,
resource, or environment filter.

...
<FileList>
  <a href="/examples/showcase/real/hybrid-cloud-transfer/README.md">Bundle README: environment, scope, topology, and cloud prerequisites ↓</a>
  <a href="/examples/showcase/real/hybrid-cloud-transfer/local-cloud-workflow.yaml">Local → GCP workflow YAML ↓</a>
  <a href="/examples/showcase/real/hybrid-cloud-transfer/local-cloud-plan.yaml">Local → GCP plan YAML ↓</a>
  <a href="/examples/showcase/real/hybrid-cloud-transfer/kind-cloud-workflow.yaml">Kind → GCP workflow YAML ↓</a>
  <a href="/examples/showcase/real/hybrid-cloud-transfer/kind-cloud-plan.yaml">Kind → GCP plan YAML ↓</a>
  <a href="/examples/showcase/real/hybrid-cloud-transfer/submit-run.sh">Run submission script ↓</a>
</FileList>

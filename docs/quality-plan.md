...
3. Additional focused Desktop captures would improve the remaining run-inspection guides. The planning and environment-catalog captures are reviewed in light and dark themes; the automated link checker is in CI.

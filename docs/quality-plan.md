...
3. Additional focused Desktop captures would improve specific SQL and lineage interaction examples. The planning, environment-catalog, execution-scope, workflow-history, SimGrid run-detail and provenance-explore captures are reviewed in light and dark themes; the automated link checker is in CI.

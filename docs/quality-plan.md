...
- [x] Fenced Bash/sh examples pass a syntax check in CI. Evidence: `docs/scripts/check-shell-examples.mjs` checked 108 authored blocks on 2026-09-13; syntax does not verify files, API requests, or JSX-embedded commands.

...
- [x] All internal links and every downloadable asset pass an automated link check. Evidence: `docs/scripts/check-links.mjs` and `.github/workflows/docs-checks.yaml`; the latest check covered 445 local route/asset links and 54 Showcase downloads on 2026-09-13.
- [x] Fenced Bash/sh examples pass a syntax check in CI. Evidence: `docs/scripts/check-shell-examples.mjs` checked 107 authored blocks on 2026-09-13 after artifact, credential, and preference sections were reorganized; syntax does not verify files, API requests, or JSX-embedded commands.

...
execFileSync("npx", ["--yes", "playwright@1.63.0", "install", "chromium"], {stdio: "inherit"});
for (const view of ["workflow", "execution", "outputs"]) {
  ...
  execFileSync("npx", ["--yes", "playwright@1.63.0", "screenshot", "--device=Desktop Chrome", "file://" + page, path.join(shots, view + ".png")], {stdio: "inherit"});
  fs.unlinkSync(page);
}

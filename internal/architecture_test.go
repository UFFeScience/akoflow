...
var legacyLineLengthLimits = map[string]int{
	...
	"application/transfer/service.go":                                         374,
	"application/transfer/service_test.go":                                    358,
	...
	"infrastructure/database/provenance/sql.go":                               402,
...
var legacyFunctionLineLimits = map[string]int{
	"api/handlers/workflow_engine_api_handler/workflow_engine_api_handler.go:CreateCloudCapacityTarget": 90,
	"api/handlers/workflow_engine_api_handler/workflow_engine_api_handler.go:GetExecution":              84,
	...
	"controlplane/execution/supervisor.go:executeActivities":                                            170,

...
type PlannedLifecycleAction = planning.PlannedLifecycleAction
...
type ActivityMetricSample = execution.ActivityMetricSample
type ActivityMetricSummary = execution.ActivityMetricSummary
type ExecutionTrace = execution.ExecutionTrace
type ExecutionTimeline = execution.ExecutionTimeline
type ExecutionTimelineTotals = execution.ExecutionTimelineTotals
type ExecutionTimelinePhase = execution.ExecutionTimelinePhase
